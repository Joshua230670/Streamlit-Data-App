...
acnh_df = pd.read_csv("//Users/joshuaizquierdo/.cache/kagglehub/datasets/jessicali9530/"
                      "animal-crossing-new-horizons-nookplaza-dataset/versions/3/"
                      f"{category}") # Create Dataframe
